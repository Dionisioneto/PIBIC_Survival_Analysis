...
source('C:/Users/Labes/OneDrive/Área de Trabalho/funcoes_sobrevivencia_pibic.R')
...
prop.table(table(dados.int$delta)) ## proporcao de censura
head(dados.int)
...
chutes = c(rep(0.1,length(grid)+1),1.5,0.1,0.1)
#chutes = c(0.3, 0.4, 0.9, 1.2, 1.2, 0.5,2.2)
