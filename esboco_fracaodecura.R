...
# 
# 
# sim.IC.FC.data = function(n, betas = c(1, 0.5, 0), lambda, 
#                           A, B, prob.bernoulli){
#   
#   ## intercepto
#   intercepto = 1
#   
#   ## dados das preditoras
#   xi1 = stats::rbinom(n, 1, prob = prob.bernoulli)
#   xi2 = stats::rnorm(n, mean = 0, sd = 1)
#   
#   z = cbind(intercepto, xi1, xi2)
#   
#   risco.cond = as.numeric(exp(betas %*% z))
#   
...
#   t = c(1:N) * NA 
#   
#   ## funcao que gere os tempos com fracao de cura
#   for (i in 1:N) {
#     T[i] <- ifelse(N_L[i] > 0, min(stats::rexp(N_L[i],
#                                                lambda)), Inf)
#   }
